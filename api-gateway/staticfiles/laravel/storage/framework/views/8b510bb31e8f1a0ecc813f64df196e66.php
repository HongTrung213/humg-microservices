...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row ">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12" data-aos="fade-down">
                    <div class="home-three-slide-face">
                        ...
                        <div class="banner-three-content">
                            <form class="form" action="<?php echo e(url('course-list')); ?>">
                ...
                <div class="col-xl-6 col-lg-4 col-md-6 col-12" data-aos="fade-up">
                    <div class="girl-slide-img aos">
                        <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/slider/home-slider.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/course-01.svg')); ?>" alt="">
                                    </div>
                        ...
                        <div class="course-details-three">
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/course-02.svg')); ?>" alt="">
                                    </div>
                                    <div class="course-content-three">
                        ...
                        <div class="course-details-three">
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/course-03.svg')); ?>" alt="">
                                    </div>
                                    <div class="course-content-three">
                        ...
                        <div class="course-details-three mb-0">
                            <div class="align-items-center">
                                <div class="course-count-three">
                                    <div class="course-img">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/course-04.svg')); ?>" alt="">
                                    </div>
    ...
    <section class="master-skill-three">
        <div class="master-three-vector">
            <img class="ellipse-right img-fluid" src="<?php echo e(URL::asset('/assets/img/bg/pattern-01.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12" data-aos="fade-right">
                    <div class="master-three-images">
                        <div class="master-three-left">
                            <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/students/career.png')); ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-down">
                                <div class="skils-icon-item">
                                    <div class="skils-icon">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/career-01.svg')); ?>"
                                            alt="certified">
                                    </div>
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-up">
                                <div class="skils-icon-item">
                                    <div class="skils-icon">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/career-02.svg')); ?>"
                                            alt="Build skills">
                                    </div>
                                    <div class="skils-content">
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-right">
                                <div class="skils-icon-item">
                                    <div class="skils-icon">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/career-03.svg')); ?>"
                                            alt="Stay Motivated">
                                    </div>
                                    <div class="skils-content">
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-left">
                                <div class="skils-icon-item">
                                    <div class="skils-icon">
                                        <img class="img-fluid"
                                            src="<?php echo e(URL::asset('/assets/img/icon-three/career-04.svg')); ?>"
                                            alt="latest cloud">
                                    </div>
                                    <div class="skils-content">
                ...
                <div class="container">
                    <div class="home-three-head section-header-title" data-aos="fade-up">
                        <div class="row align-items-center d-flex justify-content-between">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <div class="see-all">
                                    <a href="<?php echo e(url('course-details')); ?>">See all<span class="see-all-icon"><i
                    ...
                    <div class="owl-carousel home-three-favourite-carousel owl-theme aos">
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-1.svg')); ?>"
                                            ...
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="" data-bs-original-title="leader 1"><img
                                                        src="<?php echo e(URL::asset('/assets/img/profiles/avatar-01.jpg')); ?>"
                                                        alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="" data-bs-original-title="leader 2"><img
                                                        src="<?php echo e(URL::asset('/assets/img/profiles/avatar-02.jpg')); ?>"
                                                        alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="" data-bs-original-title="leader 3"><img
                                                        src="<?php echo e(URL::asset('/assets/img/profiles/avatar-03.jpg')); ?>"
                                                        alt="img"></a>
                                            </li>
                                            <li class="more-set">
                                                <a href="#">80+</a>
                        ...
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-2.svg')); ?>"
                        ...
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-3.svg')); ?>"
                        ...
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-4.svg')); ?>"
                        ...
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-5.svg')); ?>"
                                        alt="Php Development">
                                </div>
                                <div class="categories-content course-info">
                        ...
                        <div class="favourite-box" data-aos="fade-down">
                            <div class="favourite-item flex-fill">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/category/category-6.svg')); ?>"
                                                        ...
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-26.jpg')); ?>">
                                                            </a>
                                                        ...
                                                        <div class="course-three-content">
                                                            ...
                                                            <div class="student-counts-info d-flex align-items-center">
                                                                <div
                                                                    ...
                                                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/student.svg')); ?>"
                                                                        alt="">
                                                                    <p>450 Students</p>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-27.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-20.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-21.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-22.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-23.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-24.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="<?php echo e(url('course-details')); ?>">
                                                                <img class="img-fluid" alt=""
                                                                    src="<?php echo e(URL::asset('/assets/img/course/course-25.jpg')); ?>">
                                                            </a>
                                                            <div class="course-share heart-three">
                                                                <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="transform-button-three">
                        <a href="<?php echo e(url('register')); ?>" class="btn btn-action">Get Started Now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-one">
                            <img src="<?php echo e(URL::asset('/assets/img/icon-three/ellipse-1.svg')); ?>" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-two">
                            <img src="<?php echo e(URL::asset('/assets/img/icon-three/ellipse-2.svg')); ?>" alt="">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-three">
                            <img src="<?php echo e(URL::asset('/assets/img/icon-three/ellipse-3.svg')); ?>" alt="">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
    ...
    <section class="accelerate-cloud-three">
        <div class="container">
            <div class="shapes-three-right">
                <img class="accelerate-one" src="<?php echo e(URL::asset('/assets/img/bg/shape-1.png')); ?>" alt="">
                <img class="accelerate-two" src="<?php echo e(URL::asset('/assets/img/bg/pattern-03.png')); ?>" alt="">
            </div>
            <div class="shapes-three-left">
                <img class="accelerate-three" src="<?php echo e(URL::asset('/assets/img/bg/pattern-02.png')); ?>"
                    alt="">
                <img class="accelerate-four" src="<?php echo e(URL::asset('/assets/img/bg/shape-2.png')); ?>" alt="">
                <img class="accelerate-five" src="<?php echo e(URL::asset('/assets/img/bg/pattern-04.png')); ?>" alt="">
            </div>
            <div class="home-three-head section-header-title" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-right">
                        <div class="award-three-images-one">
                            <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/students/award-01.png')); ?>"
                                alt="image-banner" title="image-banner">
                        </div>
                    </div>
                        ...
                        <div class="award-three-content-one">
                            <div class="award-list-info" data-aos="fade-up">
                                <div class="award-win-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/award.svg')); ?>" alt="certified">
                                </div>
                            ...
                            <div class="award-list d-flex align-items-center">
                                <span class="award-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/check-round-1.svg')); ?>"
                                        alt="" class="img-fluid">
                                </span>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="award-three-content-two">
                            <div class="award-list-info">
                                <div class="award-win-icon">
                                    <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/icon-three/time.svg')); ?>"
                                        alt="certified">
                                </div>
                                <div class="award-list-content">
                            ...
                            <div class="award-list d-flex align-items-center">
                                <span class="award-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/check-round-2.svg')); ?>"
                                        alt="" class="img-fluid">
                                </span>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-right">
                        <div class="award-three-images-two">
                            <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/students/learn-anything.png')); ?>"
                                alt="image-banner" title="image-banner">
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-right">
                        <div class="award-three-images-three">
                            <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/students/certification.png')); ?>"
                                alt="image-banner" title="image-banner">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="award-three-content-one">
                            <div class="award-list-info">
                                <div class="award-win-icon">
                                    <img class="img-fluid"
                                        src="<?php echo e(URL::asset('/assets/img/icon-three/winning.svg')); ?>" alt="certified">
                                </div>
                                <div class="award-list-content">
                            ...
                            <div class="award-list d-flex align-items-center">
                                <span class="award-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/check-round-3.svg')); ?>"
                                        alt="" class="img-fluid">
                                </span>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                            </div>
                ...
                <div class="owl-carousel home-three-trending-course owl-theme" data-aos="fade-up">
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-one">
                            <div class="course-title-one">
                                <a href="<?php echo e(url('course-details')); ?>">Personalized Learning</a>
                            </div>
                            ...
                            <div class="trending-counts-info d-flex align-items-center justify-content-between">
                                <div class="trending-three-counts d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon-three/student-icon.svg')); ?>"
                                        alt="student-icon">
                                    <p>400 Students</p>
                                </div>
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-04.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-two">
                            <div class="course-title-one">
                                <a href="<?php echo e(url('course-details')); ?>">Python Development</a>
                            </div>
                            <div class="trending-three-text">
                                <a href="<?php echo e(url('course-details')); ?>">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-05.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-three">
                            <div class="course-title-one">
                                <a href="<?php echo e(url('course-details')); ?>">Business Management</a>
                            </div>
                            <div class="trending-three-text">
                                <a href="<?php echo e(url('course-details')); ?>">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-06.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-four">
                            <div class="course-title-one">
                                <a href="<?php echo e(url('course-details')); ?>">Creative Arts & media</a>
                            </div>
                            <div class="trending-three-text">
                                <a href="<?php echo e(url('course-details')); ?>">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-07.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-08.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-09.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="<?php echo e(url('course-details')); ?>"><img
                                            src="<?php echo e(URL::asset('/assets/img/profiles/avatar-10.jpg')); ?>"
                                            alt="img"></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="home-three-head section-header-title" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="see-all">
                            <a href="<?php echo e(url('instructor-list')); ?>">See all<span class="see-all-icon"><i
                                        class="fas fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="gallery-three-img-item">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-1.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="gallery-three-img-item">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-2.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="gallery-three-img-item mb-0">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-3.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
                            ...
                            <div class="col-lg-7 col-md-7">
                                <div class="gallery-three-img-item mb-0">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-4.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="gallery-three-img-item mb-0">
                            <div class="content-three-main">
                                <div class="gallery-img">
                                    <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-5.jpg')); ?>" alt="Instructor">
                                </div>
                                <div class="content-three-overlay">
                                    <div class="content-three-text">
                                        <div>
                                        ...
                                        <div>
                                            <a href="<?php echo e(url('instructor-list')); ?>" class="content-three-arrows">
                                                <span><i class="fas fa-arrow-right"></i></span>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="gallery-three-img-item">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-6.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="gallery-three-img-item mb-0">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-7.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="gallery-three-img-item mb-0">
                                    <div class="content-three-main">
                                        <div class="gallery-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/gallery/gallery-8.jpg')); ?>"
                                                alt="Instructor">
                                        </div>
                                        <div class="content-three-overlay">
                                            <div class="content-three-text">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-4" data-aos="fade-up">
                    <div class="become-button-three">
                        <a href="<?php echo e(url('register')); ?>" class="btn btn-become">Get Started Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="testimonial-pattern">
                <img class="pattern-left img-fluid" alt=""
                    src="<?php echo e(URL::asset('/assets/img/bg/pattern-05.svg')); ?>">
                <img class="pattern-right img-fluid" alt=""
                    src="<?php echo e(URL::asset('/assets/img/bg/pattern-06.svg')); ?>">
            </div>
            <div class="testimonial-three-content">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-12 col-md-12" data-aos="fade-down">
                        ...
                        <a href="<?php echo e(url('instructor-profile')); ?>" class="btn btn-action aos-init aos-animate"
                                    ...
                                    <div class="testimonial-item-five">
                                        <div class="testimonial-quote">
                                            <img class="quote img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/bg/quote.svg')); ?>">
                                        </div>
            ...
            <div class="home-three-head section-header-title" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="see-all">
                            <a href="<?php echo e(url('blog-list')); ?>">See all<span class="see-all-icon"><i
                                        class="fas fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="event-blog-three blog-three-one">
                                    <div class="blog-img-three">
                                        <a href="<?php echo e(url('blog-list')); ?>">
                                            <img class="img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/blog/blog-20.jpg')); ?>">
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-12" data-aos="fade-down">
                                <div class="event-blog-three blog-three-two">
                                    <div class="blog-img-three">
                                        <a href="<?php echo e(url('blog-list')); ?>">
                                            <img class="img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/blog/blog-21.jpg')); ?>">
                                        </a>
                                    </div>
                                    <div class="latest-blog-content">
                                        <div class="event-three-title">
                            ...
                            <div class="col-md-12" data-aos="fade-down">
                                <div class="event-blog-three blog-three-three">
                                    <div class="blog-img-three">
                                        <a href="<?php echo e(url('blog-list')); ?>">
                                            <img class="img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/blog/blog-22.jpg')); ?>">
                                        </a>
                                    </div>
                                    <div class="latest-blog-content">
                                        <div class="event-three-title">
                            ...
                            <div class="col-md-12" data-aos="fade-down">
                                <div class="event-blog-three blog-three-four">
                                    <div class="blog-img-three">
                                        <a href="<?php echo e(url('blog-list')); ?>">
                                            <img class="img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/blog/blog-23.jpg')); ?>">
                                        </a>
                                    </div>
                                    <div class="latest-blog-content">
                                        <div class="event-three-title">
                            ...
                            <div class="col-md-12" data-aos="fade-down">
                                <div class="event-blog-three blog-three-five">
                                    <div class="blog-img-three">
                                        <a href="<?php echo e(url('blog-list')); ?>">
                                            <img class="img-fluid" alt=""
                                                src="<?php echo e(URL::asset('/assets/img/blog/blog-24.jpg')); ?>">
                                        </a>
                                    </div>
                                    <div class="latest-blog-content">
                                        <div class="event-three-title">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/index-three.blade.php ENDPATH**/ ?>