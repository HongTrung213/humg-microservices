         ...
         <div class="card-body">
             <ul class="latest-posts">
                 <li>
                     <div class="post-thumb">
                         <a href="<?php echo e(url('blog-details')); ?>">
                             <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/blog/blog-01.jpg')); ?>"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
                         <h4>
                             <a href="<?php echo e(url('blog-details')); ?>">Learn Webs Applications Development from Experts</a>
                         </h4>
                         <p><img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/icon/icon-22.svg')); ?>"
                                 alt="">14 Jun 2023</p>
                     </div>
                 </li>
                 <li>
                     <div class="post-thumb">
                         <a href="<?php echo e(url('blog-details')); ?>">
                             <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/blog/blog-02.jpg')); ?>"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
                         <h4>
                             <a href="<?php echo e(url('blog-details')); ?>">Expand Your Career Opportunities With Python</a>
                         </h4>
                         <p><img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/icon/icon-22.svg')); ?>"
                                 alt=""> 3 Jun 2023</p>
                     </div>
                 ...
                 <li>
                     <div class="post-thumb">
                         <a href="<?php echo e(url('blog-details')); ?>">
                             <img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/blog/blog-03.jpg')); ?>"
                                 alt="">
                         </a>
                     </div>
                     <div class="post-info">
                         <h4>
                             <a href="<?php echo e(url('blog-details')); ?>">Complete PHP Programming Career Guideline</a>
                         </h4>
                         <p><img class="img-fluid" src="<?php echo e(URL::asset('/assets/img/icon/icon-22.svg')); ?>"
                                 alt=""> 13 Jun 2023</p>
                     </div>
 ...
 <!-- /Blog Sidebar -->
<?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/components/blogsidebar.blade.php ENDPATH**/ ?>