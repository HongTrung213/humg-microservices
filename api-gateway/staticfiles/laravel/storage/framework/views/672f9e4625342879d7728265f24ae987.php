                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info ttl-tickets">
                                    <div class="card-body">
                                        <img src="<?php echo e(URL::asset('/assets/img/students/ticket-total.svg')); ?>"
                                            alt="Total Tickets">
                                        <h3>50</h3>
                                        <p>Total Tickets</p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info open-tickets">
                                    <div class="card-body">
                                        <img src="<?php echo e(URL::asset('/assets/img/students/ticket-open.svg')); ?>"
                                            alt="Open Tickets">
                                        <h3>30</h3>
                                        <p>Open Tickets</p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info close-tickets">
                                    <div class="card-body">
                                        <img src="<?php echo e(URL::asset('/assets/img/students/ticket-close.svg')); ?>"
                                            alt="Close Tickets">
                                        <h3>20</h3>
                                        <p>Close Tickets</p>
                                    </div>
                            ...
                            <div class="comman-space pb-0">
                                <div class="filter-grp ticket-grp d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="ticket-btn-grp">
                                        <a href="<?php echo e(url('setting-support-new-tickets')); ?>">Add New Ticket</a>
                                    </div>
                                </div>
                                <!-- Ticket Tab -->
                                <div class="category-tab tickets-tab-blk">
                                    <ul class="nav nav-justified ">
                                        <li class="nav-item"><a href="#all" class="nav-link active"
                                                data-bs-toggle="tab">All</a></li>
                                        <li class="nav-item"><a href="#open" class="nav-link"
                                                data-bs-toggle="tab">Open</a></li>
                                        <li class="nav-item"><a href="#inprogress" class="nav-link"
                                                data-bs-toggle="tab">Inprogress</a></li>
                                        <li class="nav-item"><a href="#close" class="nav-link"
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\projectname\resources\views/setting-support-tickets.blade.php ENDPATH**/ ?>