                    ...
                    <div class="student-widget select-plan-group">
                        <div class="student-widget-group">
                            ...
                            <div class="plan-change">
                                <a href="<?php echo e(url('pricing-plan')); ?>" class="btn btn-primary">Change the Plan</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\projectname\resources\views/checkout.blade.php ENDPATH**/ ?>