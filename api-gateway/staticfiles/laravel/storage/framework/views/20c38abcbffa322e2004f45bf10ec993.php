...
$__html = app('livewire')->mount($__name, $__params, 'M6LG8Oq', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 align-self-end">
                                <div class="slider-five-one" data-aos="fade-down">
                                    <img src="<?php echo e(URL::asset('/assets/img/slider/slider-01.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="slider-five-two aos" data-aos="fade-down">
                                    <img src="<?php echo e(URL::asset('/assets/img/slider/slider-02.png')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="vector-shapes-five">
                <img src="<?php echo e(URL::asset('/assets/img/bg/banner-vector.svg')); ?>" alt="">
            </div>
        </div>
    </section>
    <!-- /Home Banner -->
                            ...
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/client/client-01.svg')); ?>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/client/client-02.svg')); ?>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/client/client-03.svg')); ?>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/client/client-04.svg')); ?>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/client/client-05.svg')); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="<?php echo e(url('job-category')); ?>">
                                        <img src="<?php echo e(URL::asset('/assets/img/course/course-01.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="course-info-btn">
                                <a href="<?php echo e(url('job-category')); ?>" class="btn-five"><i
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="<?php echo e(url('job-category')); ?>">
                                        <img src="<?php echo e(URL::asset('/assets/img/course/course-02.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="<?php echo e(url('job-category')); ?>">
                                        <img src="<?php echo e(URL::asset('/assets/img/course/course-03.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="<?php echo e(url('job-category')); ?>">
                                        <img src="<?php echo e(URL::asset('/assets/img/course/course-04.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-01.jpg')); ?>">
                                                        </a>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="<?php echo e(url('course-details')); ?>">
                                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user2.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Cristofer
                                                                        Nolen</a></h6>
                                                            </div>
                                                        ...
                                                        <h3 class="product-five-title">
                                                            <a href="<?php echo e(url('course-details')); ?>">The Complete Web
                                                ...
                                                <div class="joing-course-ovelay">
                                                    <a href="<?php echo e(url('course-details')); ?>" class="joing-course-btn">Join
                                                        Course</a>
                                                </div>
                                                <!-- Ovelay button -->
                                            </div>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-02.jpg')); ?>">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="<?php echo e(url('course-details')); ?>">
                                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user1.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Nicole Brown</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course-share-five">
                                                                <div class="rating">
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-03.jpg')); ?>">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="<?php echo e(url('course-details')); ?>">
                                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user3.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Russell T.
                                                                        Johnson</a></h6>
                                                            </div>
                                                            <div class="course-share-five">
                                                                <div class="rating">
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-04.jpg')); ?>">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="<?php echo e(url('course-details')); ?>">
                                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user4.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Nicole Brown</a>
                                                                </h6>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-05.jpg')); ?>">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="<?php echo e(url('course-details')); ?>">
                                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user5.jpg')); ?>"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Russell T.
                                                                        Johnson</a></h6>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="<?php echo e(url('course-details')); ?>">
                                                            <img class="img-fluid" alt=""
                                                                src="<?php echo e(URL::asset('/assets/img/course/featured-course-06.jpg')); ?>">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                ...
                                                                <h6><a href="<?php echo e(url('course-details')); ?>">Nicole
                                                                        Brown</a></h6>
                                                            </div>
                                                            <div class="course-share-five">
                                                                <div class="rating">
    ...
    <section class="master-section-five">
        <div class="container">
            <div class="master-five-vector">
                <img class="ellipse-right" src="<?php echo e(URL::asset('/assets/img/bg/master-vector-left.svg')); ?>"
                    alt="">
            </div>
            <div class="row">
                <div class="col-lg-6 col-sm-12" data-aos="fade-down">
                    <div class="section-five-sub">
                        ...
                        <a href="<?php echo e(url('course-list')); ?>" class="learn-more-five">Learn More</a>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/skills/skills-01.svg')); ?>" class="bg-warning"
                                        alt="Stay motivated">
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/skills/skills-02.svg')); ?>" class="bg-info"
                                        alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/skills/skills-03.svg')); ?>" class="bg-danger"
                                        alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="<?php echo e(URL::asset('/assets/img/skills/skills-04.svg')); ?>"
                ...
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="experienced-five-group">
                        <div class="instructor-vector-left">
                            <img src="<?php echo e(URL::asset('/assets/img/bg/instructor-vector-left.svg')); ?>" alt="">
                        </div>
                        <div class="developer-five-list">
                            <ul>
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-01.png')); ?>"
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-02.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-03.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-04.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-05.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-06.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-07.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-08.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-10.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-11.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-12.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-13.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-14.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-15.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="<?php echo e(URL::asset('/assets/img/profiles/profile-16.png')); ?>"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                        ...
                        <div class="instructor-vector-right">
                            <img src="<?php echo e(URL::asset('/assets/img/bg/instructor-vector-right.svg')); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="experienced-five-sub">
                        ...
                        <a href="<?php echo e(url('instructor-list')); ?>" class="learn-more-five">Start Learning</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="section-five-sub">
                            ...
                            <ul>
                                <li>
                                    <div class="knowledge-list-group">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/award-new.svg')); ?>" alt="">
                                        <p>Best Courses</p>
                                    </div>
                                </li>
                                <li class="mb-0">
                        ...
                        <a href="<?php echo e(url('course-list')); ?>" class="learn-more-five">Start Teaching Today</a>
                        <!-- /Start Teaching Today -->
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="joing-count-five text-center">
                        <img src="<?php echo e(URL::asset('/assets/img/joing-us-skill.png')); ?>" alt="">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="joing-count-five">
                        <img src="<?php echo e(URL::asset('/assets/img/education.png')); ?>" alt="">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="transform-access-content">
                        ...
                        <!-- Start Teaching Today -->
                        <a href="<?php echo e(url('instructor-course')); ?>" class="learn-more-five">Start Teaching Today</a>
                        <!-- /Start Teaching Today -->
                    </div>
                </div>
            </div>
                ...
                <div class="testimonial-five lazy slider">
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="<?php echo e(URL::asset('/assets/img/testimonial/testimonial-01.png')); ?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="<?php echo e(URL::asset('/assets/img/testimonial/testimonial-02.png')); ?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="<?php echo e(URL::asset('/assets/img/testimonial/testimonial-03.png')); ?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel home-five-blog owl-theme">
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="<?php echo e(url('blog-details')); ?>">
                            <img class="img-fluid" alt=""
                                src="<?php echo e(URL::asset('/assets/img/blog/blog-img-01.jpg')); ?>">
                        </a>
                    </div>
                    <div class="blog-box-content">
                        ...
                        <div class="blog-five-footer">
                            <h3><a href="<?php echo e(url('blog-details')); ?>">11 Tips to Help You Get New Student & Teachers
                                    2.0</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="<?php echo e(url('blog-details')); ?>">
                            <img class="img-fluid" alt=""
                                src="<?php echo e(URL::asset('/assets/img/blog/blog-img-02.jpg')); ?>">
                        </a>
                    </div>
                    <div class="blog-box-content">
                        <div class="blog-five-header d-flex align-items-center justify-content-between">
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="<?php echo e(url('blog-details')); ?>">
                            <img class="img-fluid" alt=""
                                src="<?php echo e(URL::asset('/assets/img/blog/blog-img-03.jpg')); ?>">
                        </a>
                    </div>
                    <div class="blog-box-content">
                        <div class="blog-five-header d-flex align-items-center justify-content-between">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/index-four.blade.php ENDPATH**/ ?>