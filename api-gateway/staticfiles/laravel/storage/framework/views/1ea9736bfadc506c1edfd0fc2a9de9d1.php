                ...
                <div class="col-md-12">
                    <div class="filter-grp ticket-grp tiket-suport d-flex align-items-center justify-content-between">
                        ...
                        <div class="ticket-btn-grp">
                            <a href="<?php echo e(url('setting-support-tickets')); ?>">Back to Tickets</a>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\projectname\resources\views/setting-support-new-tickets.blade.php ENDPATH**/ ?>