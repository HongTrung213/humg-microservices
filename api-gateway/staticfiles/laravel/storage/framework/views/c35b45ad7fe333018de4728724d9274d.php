        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <div class="text-end">
                        <img src="<?php echo e(URL::asset('/assets/img/plan.png')); ?>" alt="icon">
                    </div>
                        ...
                        <table class="table table-bordered table-price">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>"
                                            alt="icon"></td>
                                    <td class="text-center"><img src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>"
                                            alt="icon"></td>
                                    <td class="text-center"><img src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img
                                            src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>" alt="icon">
                                    </td>
                                    <td class="text-center"><img
                                            src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>" alt="icon">
                                    </td>
                                ...
                                <tr>
                                    <td>Multi-device</td>
                                    <td class="text-center"><img
                                            src="<?php echo e(URL::asset('/assets/img/icon/close-circle.svg')); ?>" alt="icon">
                                    </td>
                                    <td class="text-center"><img
                                            src="<?php echo e(URL::asset('/assets/img/icon/check-circle.svg')); ?>" alt="icon">
                                    </td>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/pricing-plan.blade.php ENDPATH**/ ?>