                                        ...
                                        <div class="sell-course-head student-meet-head comman-space border-0">
                                            <div class="tak-head d-flex align-items-center">
                                                ...
                                                <div class="view-icons">
                                                    <a href="<?php echo e(url('instructor-student-grid')); ?>"
                                                        class="grid-view active"><i class="feather-grid"></i></a>
                                                    <a href="<?php echo e(url('instructor-student-list')); ?>" class="list-view"><i
                                ...
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        <div class="message-text-img">
                                            <a href="javascript:;">
                                                <img class="img-fluid" alt="Students Info"
                                                    src="<?php echo e(URL::asset('/assets/img/icon/message-text.svg')); ?>">
                                            </a>
                                        </div>
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Wade Warren</a></h5>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Dianna Smiley</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>Tunisia</p>
                                            </div>
                                    ...
                                    <div class="enrol-student-foot">
                                        <ul>
                                            <li>Enrolled <span>15/06/2023</span></li>
                                            <li>Progress
                                                <div class="instruct-stip d-flex align-items-center">
                                                    <span>20%</span>
                                                    <div class="course-stip progress-stip">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Esther Howard</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>Spain</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Guy Hawkins</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>United States</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Jacob Jones</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>United Kingdom</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Kristin Watson</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>Iceland</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Rivao Luke</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>Brazil</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Nia Sikhone</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>Italy</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                <div class="student-box flex-fill">
                                    <div class="student-box-blks">
                                        ...
                                        <div class="student-content pb-0">
                                            <h5><a href="<?php echo e(url('student-profile')); ?>">Xiaon Merry</a></h5>
                                            <div class="loc-blk d-flex align-items-center justify-content-center">
                                                <i class="feather-map-pin me-2"></i>
                                                <p>France</p>
                                            </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/instructor-student-grid.blade.php ENDPATH**/ ?>