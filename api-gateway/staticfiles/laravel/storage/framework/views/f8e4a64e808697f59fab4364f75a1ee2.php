...
<?php $__env->startSection('content'); ?>
    ...
    <section class="home-two-slide d-flex align-items-center">
        <div class="container">
                ...
                <div class="col-lg-8 col-12" data-aos="fade-up">
                    <div class="home-slide-face">
                        ...
                        <div class="banner-content">
                            <form class="form" name="store" id="store" action="<?php echo e(url('course-list')); ?>">
            ...
            <!-- Shapes -->
            <div class="shapes">
                <img class="shapes-one" src="<?php echo e(URL::asset('/assets/img/bg/home-right.png')); ?>" alt="">
                <img class="shapes-two" src="<?php echo e(URL::asset('/assets/img/bg/home-right-bottom.png')); ?>" alt="">
                <img class="shapes-middle" src="<?php echo e(URL::asset('/assets/img/bg/home-middle.png')); ?>" alt="">
                <img class="shapes-four wow animate__animated animate__slideInLeft"
                    src="<?php echo e(URL::asset('/assets/img/bg/home-left.png')); ?>" alt="">
            </div>
            <!-- /Shapes -->
        </div>
    </section>
                ...
                <div class="col-lg-6 wow fadeInLeft order-lg-1 order-xs-2 order-sm-2" data-aos="fade-up">
                    ...
                    <div class="header-two-title">
                        ...
                        <div class="about-button more-details">
                            <a href="<?php echo e(url('course-list')); ?>" class="discover-btn">Learn more <i
                        ...
                        <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/count-one.svg')); ?>" alt="">
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-down">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/count-two.svg')); ?>" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-right" data-wow-delay="1.5">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/count-three.svg')); ?>" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                                            <h4><span class="counterUp">10</span>K</h4>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-left" data-wow-delay="0.5">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/count-four.svg')); ?>" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                                            <h4><span class="counterUp">10</span>K</h4>
        ...
        <div class="container">
            ...
            <div class="top-category-group">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-1.svg')); ?>"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-2.svg')); ?>"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-3.svg')); ?>"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-4.svg')); ?>" alt="Laravel Development">
                            </div>
                            <div class="categories-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-5.svg')); ?>"
                                    alt="PHP Development">
                            </div>
                            <div class="categories-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item  flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-6.svg')); ?>"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item  flex-fill">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-7.svg')); ?>" alt="Photography">
                            </div>
                            <div class="categories-content">
                                <h3>Photography</h3>
                                <p>40 Instructors</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex">
                        <div class="categories-item  flex-fill" data-aos="fade-up">
                            <div class="categories-icon">
                                <img src="<?php echo e(URL::asset('/assets/img/category/category-8.svg')); ?>" alt="Business">
                            </div>
                            <div class="categories-content">
                                <h3>Business</h3>
                                <p>40 Instructors</p>
            ...
            <div class="col-lg-12">
                <div class="more-details text-center" data-aos="fade-down">
                    <a href="<?php echo e(url('job-category')); ?>" class="discover-btn">View all Category <i
                            class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
            <!-- /View all Category -->
    ...
    <section class="featured-courses-sec">
        <div class="patter-one-main">
            <img class="patter-one" src="<?php echo e(URL::asset('/assets/img/bg/patter-one.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="header-two-title text-center" data-aos="fade-up">
                            ...
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-01.jpg')); ?>">
                                    </a>
                                ...
                                <div class="course-details-content">
                                    ...
                                    <div class="name-text featured-info-two">
                                        <h3 class="title instructor-text"><a href="<?php echo e(url('course-details')); ?>">The
                                                Complete Web
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-02.jpg')); ?>">
                                    </a>
                                    <div class="price-text">
                                ...
                                <div class="course-details-content">
                                    ...
                                    <div class="name-text featured-info-two">
                                        <h3 class="title instructor-text"><a href="<?php echo e(url('course-details')); ?>">Wordpress
                                                for
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-03.jpg')); ?>">
                                    </a>
                                    <div class="price-text">
                                ...
                                <div class="course-details-content">
                                    ...
                                    <div class="name-text featured-info-two">
                                        <h3 class="title instructor-text"><a href="<?php echo e(url('course-details')); ?>">Learn
                                                Angular
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-04.jpg')); ?>">
                                    </a>
                                    <div class="price-text">
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-05.jpg')); ?>">
                                    </a>
                                    <div class="price-text">
                                        <h4><span>C#</span></h4>
                                    </div>
                                ...
                                <div class="course-details-content">
                                    ...
                                    <div class="name-text featured-info-two">
                                        <h3 class="title instructor-text"><a href="<?php echo e(url('course-details')); ?>">C#
                                                Developers
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="<?php echo e(url('course-details')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/course/courses-06.jpg')); ?>">
                                    </a>
                                    <div class="price-text">
                                ...
                                <div class="course-details-content">
                                    ...
                                    <div class="name-text featured-info-two">
                                        <h3 class="title instructor-text"><a
                                                href="<?php echo e(url('course-details')); ?>">Information About
            ...
            <div class="col-lg-12" data-aos="fade-up">
                <div class="more-details text-center">
                    <a href="<?php echo e(url('course-details')); ?>" class="discover-btn">View all Courses <i
                            class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
            <!-- /View all  Courses -->
    ...
    <section class="growup-section">
        <div class="home-two-shapes">
            <img src="<?php echo e(URL::asset('/assets/img/bg/home-right-bottom.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-5 col-12" data-aos="fade-right">
                    <div class="growup-images-two">
                        <div class="growup-skills-img">
                            <img class="" src="<?php echo e(URL::asset('/assets/img/skil-01.png')); ?>" alt="image-banner"
                                title="image-banner">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-7 col-12 wow fadeInLeft" data-aos="fade-left">
                    ...
                    <div class="about-button more-details">
                        <a href="<?php echo e(url('register')); ?>" class="discover-btn">Join Today <i
                                class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12 order-lg-1 order-md-1 order-1" data-aos="fade-up">
                        <div class="join-mentor-img">
                            <div class="winning-two-one">
                                <img src="<?php echo e(URL::asset('/assets/img/skills/skills-01.jpg')); ?>" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="joing-icon-award">
                                <img src="<?php echo e(URL::asset('/assets/img/bg/skill-icon-01.png')); ?>" alt=""
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-12 order-lg-2 order-md-3 order-3" data-aos="fade-up">
                        <div class="join-mentor-img">
                            <div class="winning-two-two">
                                <img src="<?php echo e(URL::asset('/assets/img/skills/skills-02.jpg')); ?>" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                        <div class="joing-icon-award">
                            <img src="<?php echo e(URL::asset('/assets/img/bg/skill-icon-02.png')); ?>" alt=""
                    ...
                    <div class="col-xl-6 col-lg-5 col-md-12 order-lg-5 order-md-5 order-5" data-aos="fade-up">
                        <div class="join-mentor-img mb-0">
                            <div class="winning-two-three">
                                <img src="<?php echo e(URL::asset('/assets/img/skills/skills-03.jpg')); ?>" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                        <div class="joing-icon-award">
                            <img src="<?php echo e(URL::asset('/assets/img/bg/skill-icon-03.png')); ?>" alt=""
    ...
    <section class="testimonial-sec">
        <div class="container">
            <div class="testimonial-two-img">
                <img src="<?php echo e(URL::asset('/assets/img/bg/map-user.png')); ?>" alt="" class="img-fluid">
            </div>
                            ...
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="<?php echo e(url('instructor-profile')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/skills/skill-01.jpg')); ?>">
                                    </a>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="<?php echo e(url('instructor-profile')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/skills/skill-02.jpg')); ?>">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>C#</span></h4>
                                    </div>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="<?php echo e(url('instructor-profile')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/skills/skill-03.jpg')); ?>">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>Angular</span></h4>
                                    </div>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="<?php echo e(url('instructor-profile')); ?>">
                                        <img class="img-fluid" alt=""
                                            src="<?php echo e(URL::asset('/assets/img/skills/skill-04.jpg')); ?>">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>HTML5</span></h4>
                                    </div>
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-blue">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/joing-01.svg')); ?>" alt=""
                                                class="img-fluid">
                                        </span>
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-yellow">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/joing-02.svg')); ?>" alt=""
                                                class="img-fluid">
                                        </span>
                                        <div class="joing-content">
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-green">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/joing-03.svg')); ?>" alt=""
                                                class="img-fluid">
                                        </span>
                                ...
                                <li data-aos="fade-bottom" class="mb-0">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-orange">
                                            <img src="<?php echo e(URL::asset('/assets/img/icon/joing-04.svg')); ?>" alt=""
                                                class="img-fluid">
                                        </span>
                                        <div class="joing-content aos">
        ...
        <div class="container">
                        ...
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="<?php echo e(url('instructor-list')); ?>">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/instructor/instructor-01.jpg')); ?>">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="<?php echo e(URL::asset('/assets/img/category/category-1.svg')); ?>" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="course-details-two">
                                <div class="instructors-content text-center">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Julian Adrose</a></h5>
                                    <p>Angular Expert</p>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="<?php echo e(url('instructor-list')); ?>">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/instructor/instructor-02.jpg')); ?>">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="<?php echo e(URL::asset('/assets/img/category/category-2.svg')); ?>" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="course-details-two">
                                <div class="instructors-content text-center">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Gallegos</a></h5>
                                    <p>Python</p>
                                </div>
                                <div class="course-info"></div>
                                <div class="student-count d-flex justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="<?php echo e(url('instructor-list')); ?>">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/instructor/instructor-03.jpg')); ?>">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="<?php echo e(URL::asset('/assets/img/category/category-3.svg')); ?>" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="course-details-two">
                                <div class="instructors-content text-center">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Kristi</a></h5>
                                    <p>Node Js</p>
                                </div>
                                <div class="course-info"></div>
                                <div class="student-count d-flex justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="<?php echo e(url('instructor-list')); ?>">
                                    <img class="img-fluid" alt=""
                                        src="<?php echo e(URL::asset('/assets/img/instructor/instructor-04.jpg')); ?>">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="<?php echo e(URL::asset('/assets/img/category/category-4.svg')); ?>" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="course-details-two">
                                <div class="instructors-content text-center">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Pinero</a></h5>
                                    <p>Laravel</p>
                                </div>
                                <div class="course-info"></div>
                                <div class="student-count d-flex justify-content-center">
            ...
            <div class="col-lg-12">
                <div class="more-details text-center" data-aos="fade-up">
                    <a href="<?php echo e(url('instructor-list')); ?>" class="discover-btn discover-btn">View all Instructors <i
                            class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
            <!-- /View all Category -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="reviews-img">
                            <img src="<?php echo e(URL::asset('/assets/img/reviews-img-two.png')); ?>" alt=""
                                class="img-fluid">
                        </div>
                    </div>
    ...
    <section class="latest-blog-sec">
        <div class="container">
                        ...
                        <div class="event-blog-main">
                            ...
                            <div class="latest-blog-content">
                                <div class="event-content-title">
                                    ...
                                    <h5><a href="<?php echo e(url('blog-list')); ?>">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing
                                            elit.</a></h5>
            ...
            <div class="col-lg-12">
                <div class="more-details text-center" data-aos="fade-down">
                    <a href="<?php echo e(url('blog-grid')); ?>" class="discover-btn">View all Events<i
                            class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
            <!-- /View all  Events -->
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/index-two.blade.php ENDPATH**/ ?>