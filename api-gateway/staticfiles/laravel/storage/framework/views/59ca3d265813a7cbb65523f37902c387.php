            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="about-instructor align-items-center">
                            <div class="abt-instructor-img">
                                <a href="<?php echo e(url('instructor-profile')); ?>"><img
                                        src="<?php echo e(URL::asset('/assets/img/user/user1.jpg')); ?>" alt="img"
                                        class="img-fluid"></a>
                            </div>
                            <div class="instructor-detail me-3">
                                <h5><a href="<?php echo e(url('instructor-profile')); ?>">Nicole Brown</a></h5>
                                <p>UX/UI Designer</p>
                            </div>
                    ...
                    <div class="course-info d-flex align-items-center border-bottom-0 m-0 p-0">
                        ...
                        <div class="cou-info">
                            <img src="<?php echo e(URL::asset('/assets/img/icon/timer-icon.svg')); ?>" alt="">
                            <p>9hr 30min</p>
                        </div>
                        <div class="cou-info">
                            <img src="<?php echo e(URL::asset('/assets/img/icon/people.svg')); ?>" alt="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-card">
                                ...
                                <div id="collapseOne" class="card-collapse collapse" style="">
                                    <ul>
                                        <li>
                                            <p><img src="<?php echo e(URL::asset('/assets/img/icon/play.svg')); ?>" alt=""
                    ...
                    <div class="card instructor-sec">
                        <div class="card-body">
                            ...
                            <div class="course-info d-flex align-items-center">
                                <div class="cou-info">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon/play.svg')); ?>" alt="">
                                    <p>5 Courses</p>
                                </div>
                                <div class="cou-info">
                                    <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" alt="">
                    ...
                    <div class="sidebar-sec">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail"
                                        ...
                                        <img class="" src="<?php echo e(URL::asset('/assets/img/video.jpg')); ?>"
                                            alt="">
                                    </a>
                                    <div class="video-details">
                                        ...
                                        <div class="row gx-2">
                                            <div class="col-md-6">
                                                <a href="<?php echo e(url('course-wishlist')); ?>" class="btn btn-wish w-100"><i
                                        ...
                                        <a href="<?php echo e(url('checkout')); ?>" class="btn btn-enroll w-100">Enroll Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card include-sec">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/import.svg')); ?>" class="me-2"
                                            alt=""> 11 hours on-demand video</li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/play.svg')); ?>" class="me-2"
                                            alt=""> 69 downloadable resources</li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/key.svg')); ?>" class="me-2"
                                            alt=""> Full lifetime access</li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/mobile.svg')); ?>" class="me-2"
                                            alt=""> Access on mobile and TV</li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/cloud.svg')); ?>" class="me-2"
                                            alt=""> Assignments</li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/teacher.svg')); ?>" class="me-2"
                        ...
                        <div class="card feature-sec">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/users.svg')); ?>" class="me-2"
                                            alt=""> Enrolled: <span>32 students</span></li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/timer.svg')); ?>" class="me-2"
                                            alt=""> Duration: <span>20 hours</span></li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/chapter.svg')); ?>" class="me-2"
                                            alt=""> Chapters: <span>15</span></li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/video.svg')); ?>" class="me-2"
                                            alt=""> Video:<span> 12 hours</span></li>
                                    <li><img src="<?php echo e(URL::asset('/assets/img/icon/chart.svg')); ?>" class="me-2"
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\projectname\resources\views/course-details.blade.php ENDPATH**/ ?>