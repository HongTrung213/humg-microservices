...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.courseheader'); ?>
                                ...
                                <div class="chat-users-list">
                                    <div class="chat-scroll">
                                        ...
                                        <a href="javascript:void(0);" class="media d-flex">
                                            <div class="media-img-wrap flex-shrink-0">
                                                <div class="avatar avatar-away">
                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user6.jpg')); ?>"
                                                        alt="User Image" class="avatar-img rounded-circle">
                                                </div>
                                            </div>
                                            <div class="media-body flex-grow-1">
                                        ...
                                        <a href="javascript:void(0);" class="media d-flex">
                                            <div class="media-img-wrap flex-shrink-0">
                                                <div class="avatar avatar-away">
                                                    <img src="<?php echo e(URL::asset('/assets/img/user/user7.jpg')); ?>"
                                                        alt="User Image" class="avatar-img rounded-circle">
                                                </div>
                                            </div>
                                            <div class="media-body flex-grow-1">
                                    ...
                                    <div class="chat-options">
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="btn btn-outline-light no-bg" href="javascript:;"
                                ...
                                <div class="chat-footer">
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-primary msg-send-btn rounded-pill"><img
                                                src="<?php echo e(URL::asset('/assets/img/send-icon.svg')); ?>"
                                                alt=""></button>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\dreams-lms_laravel\resources\views/instructor-chat.blade.php ENDPATH**/ ?>