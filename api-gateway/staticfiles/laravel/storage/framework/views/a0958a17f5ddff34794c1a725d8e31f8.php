                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Rolands R</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                                        <p>12+ Lesson</p>
                                    </div>
                                    <div class="course-view d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-02.svg')); ?>" class="me-1"
                                            alt="">
                                        <p>9hr 30min</p>
                                    </div>
                                    <div class="rating">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Jenis R.</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Jesse Stevens</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Stevens Jes</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">John Smith</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Stella Johnson</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">John Michael</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="instructor-box flex-fill">
                                ...
                                <div class="instructor-content">
                                    <h5><a href="<?php echo e(url('instructor-profile')); ?>">Monroe Parker</a></h5>
                                    <h6>Instructor</h6>
                                    <div class="rating-img d-flex align-items-center justify-content-center">
                                        <img src="<?php echo e(URL::asset('/assets/img/icon/icon-01.svg')); ?>" class="me-1"
                                            alt="">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DreamsLms-laravel\projectname\resources\views/instructor-grid.blade.php ENDPATH**/ ?>