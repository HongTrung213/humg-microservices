                                ...
                                <div class="card withdraw-box flex-fill">
                                    <div class="card-body">
                                        <div class="widra-your-money d-flex align-items-end justify-content-between">
                                            ...
                                            <div>
                                                <img src="{{ URL::asset('/assets/img/bank-image.png') }}"
                                                    alt="Withdraw money">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        ...
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img1.png') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img2.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Dianna Smiley</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img3.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Guy Hawkins</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img4.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Jacob Jones</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img5.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Kristin Watson</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img6.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Rivao Luke</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img7.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Nia Sikhone</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img8.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Xiaon Merry</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img9.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Guy Hawkins</p>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('student-profile') }}"
                                                        class="refer-avatar-blk d-flex align-items-center">
                                                        <img src="{{ URL::asset('/assets/img/students/refer-img10.png') }}"
                                                            class="rounded-circle me-2" alt="Referred User Info">
                                                        <p>Dianna Smiley</p>
                                                    </a>
                                                </td>
