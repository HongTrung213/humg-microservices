                ...
                <div class="row">
                    <div class="col-md-4 d-flex">
                        <div class="price-box w-100">
                            <h4>Basic</h4>
                            <p>For individuals who just need to start with the basic features per user, per month when
                                billed monthly</p>
                            <h3><span>$</span>10</h3>
                            <h5>Benefits</h5>
                            <ul>
                    ...
                    <div class="col-md-4 d-flex">
                        <div class="price-box w-100">
                            ...
                            <p>For teams who just need to start with the basic features per user, per month when billed
                                monthly</p>
                            <h3><span>$</span>50</h3>
                            <h5>Benefits</h5>
                            <ul>
                    ...
                    <div class="col-md-4 d-flex">
                        <div class="price-box w-100">
                            <h4>Pro</h4>
                            <p>For medium businesses who need advanced features for their activity per user, per month
                                billed monthly</p>
                            <h3><span>$</span>100</h3>
                            <h5>Benefits</h5>
                            <ul>
                        ...
                        <table class="table table-bordered table-price">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}"
                                            alt="icon"></td>
                                    <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}"
                                            alt="icon"></td>
                                    <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img
                                            src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}" alt="icon">
                                    </td>
                                    <td class="text-center"><img
                                            src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}" alt="icon">
                                    </td>
                                ...
                                <tr>
                                    <td>Multi-device</td>
                                    <td class="text-center"><img
                                            src="{{ URL::asset('/assets/img/icon/close-circle.svg') }}" alt="icon">
                                    </td>
                                    <td class="text-center"><img
                                            src="{{ URL::asset('/assets/img/icon/check-circle.svg') }}" alt="icon">
                                    </td>
