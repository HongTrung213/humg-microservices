                        ...
                        <div class="settings-inner-blk new-ticket-blk p-0">
                            ...
                            <div class="comman-space-ticket bdr-bottom-line">
                                <div class="ticket-profile">
                                    ...
                                    <ul class="admin-msg-list">
                                        ...
                                        <li>It's been [NUMBER OF DAYS] days since we've heard from you, so I wanted to let
                                            you know that we are going to close this ticket.</li>
                            ...
                            <div class="comman-space-ticket ">
                                <div class="ticket-profile">
                                    ...
                                    <p class="mb-0">no, that solutions is not working if i restart it, still not able to
                                        detect the microphone while on call </p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="comman-space ">
                                <div class="ticket-view-blk bdr-bottom-line pt-0">
                                    ...
                                    <div class="requested-img d-flex align-items-center">
                                        <a href="javascript:;"><img src="{{ URL::asset('/assets/img/user/user11.jpg') }}"
                                ...
                                <div class="ticket-view-blk bdr-bottom-line">
                                    <h5>Last Activity</h5>
                                    <h3>24/06/2023 00:34:15</h3>
                                </div>
                                <div class="ticket-view-blk bdr-bottom-line">
                                    <h5>Created</h5>
                                    <h3>30/03/2023 08:46:06</h3>
                                </div>
