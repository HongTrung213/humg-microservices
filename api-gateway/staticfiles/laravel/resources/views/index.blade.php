                                ...
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/course-01.jpg') }}">
                                    </a>
                                    <div class="price">
                                    ...
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user1.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                        ...
                        <div class="course-box d-flex aos" data-aos="fade-up">
                            <div class="product">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/course-02.jpg') }}">
                                    </a>
                                    <div class="price">
                                ...
                                <div class="product-content">
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user2.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                                            <div class="course-name">
                        ...
                        <div class="course-box d-flex aos" data-aos="fade-up">
                            <div class="product">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/course-03.jpg') }}">
                                    </a>
                                ...
                                <div class="product-content">
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user5.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                                            <div class="course-name">
                            ...
                            <div class="product">
                                ...
                                <div class="product-content">
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user4.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                                            <div class="course-name">
                                                <h4><a href="{{ url('instructor-profile') }}">Nicole Brown</a></h4>
                                                <p>Instructor</p>
                        ...
                        <div class="course-box d-flex aos" data-aos="fade-up">
                            <div class="product">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/course-05.jpg') }}">
                                    </a>
                                    <div class="price">
                                        <h3>$300 <span>$99.00</span></h3>
                                    </div>
                                ...
                                <div class="product-content">
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user3.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                                            <div class="course-name">
                        ...
                        <div class="course-box d-flex aos" data-aos="fade-up">
                            <div class="product">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/course-06.jpg') }}">
                                    </a>
                                    <div class="price combo">
                                        <h3>FREE</h3>
                                    </div>
                                ...
                                <div class="product-content">
                                    <div class="course-group d-flex">
                                        <div class="course-group-img d-flex">
                                            <a href="{{ url('instructor-profile') }}"><img
                                                    src="{{ URL::asset('/assets/img/user/user6.jpg') }}" alt=""
                                                    class="img-fluid"></a>
                                            <div class="course-name">
                                    ...
                                    <div class="get-certified d-flex align-items-center">
                                        <div class="blur-box">
                                            <div class="certified-img ">
                                                <img src="{{ URL::asset('/assets/img/icon/icon-1.svg') }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group blur-border d-flex">
                                    <div class="get-certified d-flex align-items-center">
                                        <div class="blur-box">
                                            <div class="certified-img ">
                                                <img src="{{ URL::asset('/assets/img/icon/icon-2.svg') }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group blur-border d-flex">
                                    <div class="get-certified d-flex align-items-center">
                                        <div class="blur-box">
                                            <div class="certified-img ">
                                                <img src="{{ URL::asset('/assets/img/icon/icon-3.svg') }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group blur-border d-flex">
                                    <div class="get-certified d-flex align-items-center">
                                        <div class="blur-box">
                                            <div class="certified-img ">
                                                <img src="{{ URL::asset('/assets/img/icon/icon-4.svg') }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                ...
                <div class="course-box trend-box">
                    <div class="product trend-product">
                        <div class="product-img">
                            <a href="{{ url('course-details') }}">
                                <img class="img-fluid" alt=""
                                    src="{{ URL::asset('/assets/img/course/course-07.jpg') }}">
                            </a>
                            <div class="price">
                        ...
                        <div class="product-content">
                            <div class="course-group d-flex">
                                <div class="course-group-img d-flex">
                                    <a href="{{ url('instructor-profile') }}"><img
                                            src="{{ URL::asset('/assets/img/user/user.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="course-name">
                ...
                <div class="course-box trend-box">
                    <div class="product trend-product">
                        <div class="product-img">
                            <a href="{{ url('course-details') }}">
                                <img class="img-fluid" alt=""
                                    src="{{ URL::asset('/assets/img/course/course-08.jpg') }}">
                            </a>
                            <div class="price">
                                <h3>$300 <span>$99.00</span></h3>
                            </div>
                ...
                <div class="course-box trend-box">
                    <div class="product trend-product">
                        <div class="product-img">
                            <a href="{{ url('course-details') }}">
                                <img class="img-fluid" alt=""
                                    src="{{ URL::asset('/assets/img/course/course-09.jpg') }}">
                            </a>
                            <div class="price">
                                <h3>$100 <span>$99.00</span></h3>
                            </div>
                ...
                <div class="owl-carousel instructors-course owl-theme aos" data-aos="fade-up">
                    ...
                    <div class="instructors-widget">
                        <div class="instructors-img">
                            <a href="{{ url('instructor-list') }}">
                                <img class="img-fluid" alt=""
                                    src="{{ URL::asset('/assets/img/user/user9.jpg') }}">
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                    ...
                    <div class="instructors-widget">
                        <div class="instructors-img">
                            <a href="{{ url('instructor-list') }}">
                                <img class="img-fluid" alt=""
                                    src="{{ URL::asset('/assets/img/user/user10.jpg') }}">
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="mentor-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/become-02.png') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="student-mentor yellow-mentor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="mentor-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/become-01.png') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row ">
                        ...
                        <div class="total-course d-flex align-items-center">
                            <div class="blur-border">
                                <div class="enroll-img ">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-07.svg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="total-course d-flex align-items-center">
                            <div class="blur-border">
                                <div class="enroll-img ">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-08.svg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="course-count">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="total-course d-flex align-items-center">
                            <div class="blur-border">
                                <div class="enroll-img ">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-09.svg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="course-count">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-10.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-16.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-12.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-13.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-14.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-15.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-17.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1 col-3">
                                <div class="total-course d-flex align-items-center">
                                    <div class="blur-border">
                                        <div class="enroll-img ">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-18.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
