...
urlpatterns = [
    ...
    path('admin/bao-luu/', gateway_views.bao_luu_diem_list, name='bao_luu_diem_list'),
    ...
    # Import sinh viên vào l?p & schedule
    ...
    # Xu?t b?ng di?m, g?i email, duy?t ch?ng ch?, duy?t dang ký
