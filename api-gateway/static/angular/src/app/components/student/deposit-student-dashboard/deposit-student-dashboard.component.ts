...
export class DepositStudentDashboardComponent implements OnInit {
  ...
  public depositStudentDashboard: DepositStudentDashboard[] = [];

  public latestTransactions: latestTransactions[] = [];
  ...
  private tableData(): void {
    ...
    this.DataService.latestTransactionsList().subscribe((res) => {
      res.data.map((res: latestTransactions) => {
