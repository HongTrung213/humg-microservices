                  ...
                  <div class="card stat-info open-tickets">
                    <div class="card-body">
                      <div class="view-all-grp d-flex">
                        ...
                        <div class="img-deposit-ticket">
                          <img
                            src="@/assets/img/students/receipt-text.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div class="card stat-info close-tickets">
                    <div class="card-body">
                      <div class="view-all-grp d-flex">
                        ...
                        <div class="img-deposit-ticket">
                          <img
                            src="@/assets/img/students/empty-wallet-tick.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div class="card stat-info medium-tickets">
                    <div class="card-body">
                      <div class="view-all-grp d-flex">
                        ...
                        <div class="img-deposit-ticket">
                          <img
                            src="@/assets/img/students/empty-wallet-change.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div class="card stat-info blue-tickets">
                    <div class="card-body">
                      <div class="view-all-grp d-flex">
                        ...
                        <div class="img-deposit-ticket">
                          <img
                            src="@/assets/img/students/profile-user.svg"
                            alt=""
                          />
                        </div>
                      </div>
