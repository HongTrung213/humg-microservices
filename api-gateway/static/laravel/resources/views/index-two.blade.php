...
@section('content')
    ...
    <section class="home-two-slide d-flex align-items-center">
        <div class="container">
            ...
            <!-- Shapes -->
            <div class="shapes">
                <img class="shapes-one" src="{{ URL::asset('/assets/img/bg/home-right.png') }}" alt="">
                <img class="shapes-two" src="{{ URL::asset('/assets/img/bg/home-right-bottom.png') }}" alt="">
                <img class="shapes-middle" src="{{ URL::asset('/assets/img/bg/home-middle.png') }}" alt="">
                <img class="shapes-four wow animate__animated animate__slideInLeft"
                    src="{{ URL::asset('/assets/img/bg/home-left.png') }}" alt="">
            </div>
            <!-- /Shapes -->
        </div>
    </section>
                        ...
                        <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="{{ URL::asset('/assets/img/icon/count-one.svg') }}" alt="">
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-down">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="{{ URL::asset('/assets/img/icon/count-two.svg') }}" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-right" data-wow-delay="1.5">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="{{ URL::asset('/assets/img/icon/count-three.svg') }}" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                                            <h4><span class="counterUp">10</span>K</h4>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-aos="fade-left" data-wow-delay="0.5">
                                <div
                                    ...
                                    <div class="about-count">
                                        <div class="course-img">
                                            <img src="{{ URL::asset('/assets/img/icon/count-four.svg') }}" alt="">
                                        </div>
                                        <div class="count-content-three course-count ms-0">
                                            <h4><span class="counterUp">10</span>K</h4>
            ...
            <div class="top-category-group">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-1.svg') }}"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-2.svg') }}"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-3.svg') }}"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-4.svg') }}" alt="Laravel Development">
                            </div>
                            <div class="categories-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-5.svg') }}"
                                    alt="PHP Development">
                            </div>
                            <div class="categories-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item  flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-6.svg') }}"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
                        <div class="categories-item  flex-fill">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-7.svg') }}" alt="Photography">
                            </div>
                            <div class="categories-content">
                                <h3>Photography</h3>
                                <p>40 Instructors</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 d-flex">
                        <div class="categories-item  flex-fill" data-aos="fade-up">
                            <div class="categories-icon">
                                <img src="{{ URL::asset('/assets/img/category/category-8.svg') }}" alt="Business">
                            </div>
                            <div class="categories-content">
                                <h3>Business</h3>
                                <p>40 Instructors</p>
    ...
    <section class="featured-courses-sec">
        <div class="patter-one-main">
            <img class="patter-one" src="{{ URL::asset('/assets/img/bg/patter-one.png') }}" alt="">
        </div>
        <div class="container">
            <div class="header-two-title text-center" data-aos="fade-up">
                                ...
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-01.jpg') }}">
                                    </a>
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-02.jpg') }}">
                                    </a>
                                    <div class="price-text">
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-03.jpg') }}">
                                    </a>
                                    <div class="price-text">
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-04.jpg') }}">
                                    </a>
                                    <div class="price-text">
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-05.jpg') }}">
                                    </a>
                                    <div class="price-text">
                                        <h4><span>C#</span></h4>
                                    </div>
                        ...
                        <div class="featured-details-two">
                            <div class="product-item-two">
                                <div class="product-img-two">
                                    <a href="{{ url('course-details') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/course/courses-06.jpg') }}">
                                    </a>
                                    <div class="price-text">
    ...
    <section class="growup-section">
        <div class="home-two-shapes">
            <img src="{{ URL::asset('/assets/img/bg/home-right-bottom.png') }}" alt="">
        </div>
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-6 col-md-5 col-12" data-aos="fade-right">
                    <div class="growup-images-two">
                        <div class="growup-skills-img">
                            <img class="" src="{{ URL::asset('/assets/img/skil-01.png') }}" alt="image-banner"
                                title="image-banner">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 order-lg-1 order-md-1 order-1" data-aos="fade-up">
                        <div class="join-mentor-img">
                            <div class="winning-two-one">
                                <img src="{{ URL::asset('/assets/img/skills/skills-01.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="joing-icon-award">
                                <img src="{{ URL::asset('/assets/img/bg/skill-icon-01.png') }}" alt=""
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-12 order-lg-2 order-md-3 order-3" data-aos="fade-up">
                        <div class="join-mentor-img">
                            <div class="winning-two-two">
                                <img src="{{ URL::asset('/assets/img/skills/skills-02.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                        <div class="joing-icon-award">
                            <img src="{{ URL::asset('/assets/img/bg/skill-icon-02.png') }}" alt=""
                    ...
                    <div class="col-xl-6 col-lg-5 col-md-12 order-lg-5 order-md-5 order-5" data-aos="fade-up">
                        <div class="join-mentor-img mb-0">
                            <div class="winning-two-three">
                                <img src="{{ URL::asset('/assets/img/skills/skills-03.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                        <div class="joing-icon-award">
                            <img src="{{ URL::asset('/assets/img/bg/skill-icon-03.png') }}" alt=""
    ...
    <section class="testimonial-sec">
        <div class="container">
            <div class="testimonial-two-img">
                <img src="{{ URL::asset('/assets/img/bg/map-user.png') }}" alt="" class="img-fluid">
            </div>
                            ...
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="{{ url('instructor-profile') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/skills/skill-01.jpg') }}">
                                    </a>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="{{ url('instructor-profile') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/skills/skill-02.jpg') }}">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>C#</span></h4>
                                    </div>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="{{ url('instructor-profile') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/skills/skill-03.jpg') }}">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>Angular</span></h4>
                                    </div>
                        ...
                        <div class="trending-courses-group">
                            <div class="trending-courses-two">
                                <div class="product-img course-column-img">
                                    <a href="{{ url('instructor-profile') }}">
                                        <img class="img-fluid" alt=""
                                            src="{{ URL::asset('/assets/img/skills/skill-04.jpg') }}">
                                    </a>
                                    <div class="trending-price">
                                        <h4><span>HTML5</span></h4>
                                    </div>
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-blue">
                                            <img src="{{ URL::asset('/assets/img/icon/joing-01.svg') }}" alt=""
                                                class="img-fluid">
                                        </span>
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-yellow">
                                            <img src="{{ URL::asset('/assets/img/icon/joing-02.svg') }}" alt=""
                                                class="img-fluid">
                                        </span>
                                        <div class="joing-content">
                                ...
                                <li data-aos="fade-bottom">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-green">
                                            <img src="{{ URL::asset('/assets/img/icon/joing-03.svg') }}" alt=""
                                                class="img-fluid">
                                        </span>
                                ...
                                <li data-aos="fade-bottom" class="mb-0">
                                    <div class="joing-header">
                                        <span class="joing-icon bg-orange">
                                            <img src="{{ URL::asset('/assets/img/icon/joing-04.svg') }}" alt=""
                                                class="img-fluid">
                                        </span>
                                        <div class="joing-content aos">
                        ...
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="{{ url('instructor-list') }}">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/instructor/instructor-01.jpg') }}">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="{{ URL::asset('/assets/img/category/category-1.svg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="{{ url('instructor-list') }}">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/instructor/instructor-02.jpg') }}">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="{{ URL::asset('/assets/img/category/category-2.svg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="{{ url('instructor-list') }}">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/instructor/instructor-03.jpg') }}">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="{{ URL::asset('/assets/img/category/category-3.svg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="{{ url('instructor-list') }}">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/instructor/instructor-04.jpg') }}">
                                </a>
                                <div class="featured-border">
                                    <div class="featured-img ">
                                        <img src="{{ URL::asset('/assets/img/category/category-4.svg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="reviews-img">
                            <img src="{{ URL::asset('/assets/img/reviews-img-two.png') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
