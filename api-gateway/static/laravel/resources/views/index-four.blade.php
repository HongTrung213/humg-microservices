    ...
    <section class="home-slide-five">
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6 align-self-end">
                                <div class="slider-five-one" data-aos="fade-down">
                                    <img src="{{ URL::asset('/assets/img/slider/slider-01.png') }}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="slider-five-two aos" data-aos="fade-down">
                                    <img src="{{ URL::asset('/assets/img/slider/slider-02.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="vector-shapes-five">
                <img src="{{ URL::asset('/assets/img/bg/banner-vector.svg') }}" alt="">
            </div>
        </div>
    </section>
    <!-- /Home Banner -->
                            ...
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/client/client-01.svg') }}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/client/client-02.svg') }}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/client/client-03.svg') }}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/client/client-04.svg') }}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt=""
                                        src="{{ URL::asset('/assets/img/client/client-05.svg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="{{ url('job-category') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-01.svg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="{{ url('job-category') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-02.svg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="{{ url('job-category') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-03.svg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                    ...
                    <div class="course-five-item">
                        <div class="course-five-grid">
                            <div class="course-icon-five">
                                <div class="icon-five-border">
                                    <a href="{{ url('job-category') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-04.svg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="course-info-five">
                                                ...
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-01.jpg') }}">
                                                        </a>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="{{ url('course-details') }}">
                                                                    <img src="{{ URL::asset('/assets/img/user/user2.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-02.jpg') }}">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="{{ url('course-details') }}">
                                                                    <img src="{{ URL::asset('/assets/img/user/user1.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-03.jpg') }}">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="{{ url('course-details') }}">
                                                                    <img src="{{ URL::asset('/assets/img/user/user3.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-04.jpg') }}">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="{{ url('course-details') }}">
                                                                    <img src="{{ URL::asset('/assets/img/user/user4.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="{{ url('course-details') }}">Nicole Brown</a>
                                                                </h6>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-05.jpg') }}">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-five">
                                                        <div class="course-group-five">
                                                            <div class="course-group-img-five">
                                                                <a href="{{ url('course-details') }}">
                                                                    <img src="{{ URL::asset('/assets/img/user/user5.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                </a>
                                                                <h6><a href="{{ url('course-details') }}">Russell T.
                                                                        Johnson</a></h6>
                                            ...
                                            <div class="course-box-five">
                                                <div class="product-five">
                                                    ...
                                                    <div class="product-img-five">
                                                        <a href="{{ url('course-details') }}">
                                                            <img class="img-fluid" alt=""
                                                                src="{{ URL::asset('/assets/img/course/featured-course-06.jpg') }}">
                                                        </a>
                                                        <div class="course-share heart-five">
                                                            <a href="#rate"><i class="fa-regular fa-heart"></i></a>
                                                        </div>
    ...
    <section class="master-section-five">
        <div class="container">
            <div class="master-five-vector">
                <img class="ellipse-right" src="{{ URL::asset('/assets/img/bg/master-vector-left.svg') }}"
                    alt="">
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="{{ URL::asset('/assets/img/skills/skills-01.svg') }}" class="bg-warning"
                                        alt="Stay motivated">
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="{{ URL::asset('/assets/img/skills/skills-02.svg') }}" class="bg-info"
                                        alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="{{ URL::asset('/assets/img/skills/skills-03.svg') }}" class="bg-danger"
                                        alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon">
                                    <img src="{{ URL::asset('/assets/img/skills/skills-04.svg') }}"
                ...
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="experienced-five-group">
                        <div class="instructor-vector-left">
                            <img src="{{ URL::asset('/assets/img/bg/instructor-vector-left.svg') }}" alt="">
                        </div>
                        <div class="developer-five-list">
                            <ul>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-04.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-05.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-06.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-07.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-08.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-10.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-11.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-12.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-13.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-14.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-15.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile-16.png') }}"
                                                alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                        ...
                        <div class="instructor-vector-right">
                            <img src="{{ URL::asset('/assets/img/bg/instructor-vector-right.svg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-down">
            ...
            <div class="row align-items-center">
                            ...
                            <ul>
                                <li>
                                    <div class="knowledge-list-group">
                                        <img src="{{ URL::asset('/assets/img/icon/award-new.svg') }}" alt="">
                                        <p>Best Courses</p>
                                    </div>
                                </li>
                                <li class="mb-0">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="joing-count-five text-center">
                        <img src="{{ URL::asset('/assets/img/joing-us-skill.png') }}" alt="">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-down">
                    <div class="joing-count-five">
                        <img src="{{ URL::asset('/assets/img/education.png') }}" alt="">
                ...
                <div class="testimonial-five lazy slider">
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="{{ URL::asset('/assets/img/testimonial/testimonial-01.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="{{ URL::asset('/assets/img/testimonial/testimonial-02.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-image">
                                <img src="{{ URL::asset('/assets/img/testimonial/testimonial-03.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel home-five-blog owl-theme">
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="{{ url('blog-details') }}">
                            <img class="img-fluid" alt=""
                                src="{{ URL::asset('/assets/img/blog/blog-img-01.jpg') }}">
                        </a>
                    </div>
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="{{ url('blog-details') }}">
                            <img class="img-fluid" alt=""
                                src="{{ URL::asset('/assets/img/blog/blog-img-02.jpg') }}">
                        </a>
                    </div>
                    <div class="blog-box-content">
                        <div class="blog-five-header d-flex align-items-center justify-content-between">
                ...
                <div class="blog-five-item">
                    <div class="product-img-five">
                        <a href="{{ url('blog-details') }}">
                            <img class="img-fluid" alt=""
                                src="{{ URL::asset('/assets/img/blog/blog-img-03.jpg') }}">
                        </a>
                    </div>
                    <div class="blog-box-content">
                        <div class="blog-five-header d-flex align-items-center justify-content-between">
