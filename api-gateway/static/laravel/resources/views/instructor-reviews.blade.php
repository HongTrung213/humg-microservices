                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="instruct-search-blk mb-0">
                                            <div class="show-filter all-select-blk">
                                                <form action="#">
                                                    @livewire('select2-instructor-reviews')
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="review-item">
                                                <div class="instructor-wrap border-0 m-0">
                                                    <div class="about-instructor">
                                                        ...
                                                        <div class="instructor-detail">
                                                            <h5><a href="{{ url('instructor-profile') }}">Jesse Stevens</a>
                                                            </h5>
                                                            <p>UX/UI Designer</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="review-item">
                                                <div class="instructor-wrap border-0 m-0">
                                                    <div class="about-instructor">
                                                        ...
                                                        <div class="instructor-detail">
                                                            <h5><a href="{{ url('instructor-profile') }}">John Smith</a>
                                                            </h5>
                                                            <p>UX/UI Designer</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="review-item">
                                                <div class="instructor-wrap border-0 m-0">
                                                    <div class="about-instructor">
                                                        ...
                                                        <div class="instructor-detail">
                                                            <h5><a href="{{ url('instructor-profile') }}">Stella
                                                                    Johnson</a></h5>
                                                            <p>UX/UI Designer</p>
                                                        </div>
                                                    </div>
