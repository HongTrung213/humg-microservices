...
@endif
@if (Route::is(['setting-student-payment']))
    <!-- Modal -->
    <div class="modal custom-modal fade" id="addpaymentMethod" tabindex="-1" aria-labelledby="addpaymentMethod"
        aria-hidden="true">
    ...
    <!-- Modal -->
@endif
@if (Route::is(['withdrawal-instructor', 'deposit-student']))
    <!-- Deposit Modal -->
                                    ...
                                    <div class="radio-with-img">
                                        <p class="radio-deposit-item">
                                            ...
                                            <label for="deposit-type-one">
                                                <img src="{{ URL::asset('/assets/img/deposit-01.jpg') }}"
                                                    alt="" class="img-fluid">
                                                Bank
                                            </label>
                                        </p>
                                        <p class="radio-deposit-item">
                                            ...
                                            <label for="deposit-type-two">
                                                <img src="{{ URL::asset('/assets/img/deposit-02.jpg') }}"
                                                    alt="" class="img-fluid">
                                                Paypal
                                            </label>
                                        </p>
                                        <p class="radio-deposit-item">
                                            ...
                                            <label for="deposit-type-three">
                                                <img src="{{ URL::asset('/assets/img/deposit-03.jpg') }}"
                                                    alt="" class="img-fluid">
                                                Stripe
                                            </label>
                                        </p>
                                        <p class="radio-deposit-item me-0">
                                            ...
                                            <label for="deposit-type-four">
                                                <img src="{{ URL::asset('/assets/img/deposit-04.jpg') }}"
                                                    alt="" class="img-fluid">
                                                Flutterwave - USD
                                            </label>
                                        </p>
