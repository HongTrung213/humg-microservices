                        ...
                        <div class="about-instructor align-items-center">
                            <div class="abt-instructor-img">
                                <a href="{{ url('instructor-profile') }}"><img
                                        src="{{ URL::asset('/assets/img/user/user1.jpg') }}" alt="img"
                                        class="img-fluid"></a>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-card">
                                ...
                                <div id="collapseOne" class="card-collapse collapse" style="">
                                    <ul>
                                        <li>
                                            <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}" alt=""
                    ...
                    <div class="sidebar-sec">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail"
                                        ...
                                        <img class="" src="{{ URL::asset('/assets/img/video.jpg') }}"
                                            alt="">
                                    </a>
                        ...
                        <div class="card include-sec">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><img src="{{ URL::asset('/assets/img/icon/import.svg') }}" class="me-2"
                                            alt=""> 11 hours on-demand video</li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/play.svg') }}" class="me-2"
                                            alt=""> 69 downloadable resources</li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/key.svg') }}" class="me-2"
                                            alt=""> Full lifetime access</li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/mobile.svg') }}" class="me-2"
                                            alt=""> Access on mobile and TV</li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/cloud.svg') }}" class="me-2"
                                            alt=""> Assignments</li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/teacher.svg') }}" class="me-2"
                        ...
                        <div class="card feature-sec">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><img src="{{ URL::asset('/assets/img/icon/users.svg') }}" class="me-2"
                                            alt=""> Enrolled: <span>32 students</span></li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/timer.svg') }}" class="me-2"
                                            alt=""> Duration: <span>20 hours</span></li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/chapter.svg') }}" class="me-2"
                                            alt=""> Chapters: <span>15</span></li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/video.svg') }}" class="me-2"
                                            alt=""> Video:<span> 12 hours</span></li>
                                    <li><img src="{{ URL::asset('/assets/img/icon/chart.svg') }}" class="me-2"
