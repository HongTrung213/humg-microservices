                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info ttl-tickets">
                                    <div class="card-body">
                                        <img src="{{ URL::asset('/assets/img/students/ticket-total.svg') }}"
                                            alt="Total Tickets">
                                        <h3>50</h3>
                                        <p>Total Tickets</p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info open-tickets">
                                    <div class="card-body">
                                        <img src="{{ URL::asset('/assets/img/students/ticket-open.svg') }}"
                                            alt="Open Tickets">
                                        <h3>30</h3>
                                        <p>Open Tickets</p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card stat-info close-tickets">
                                    <div class="card-body">
                                        <img src="{{ URL::asset('/assets/img/students/ticket-close.svg') }}"
                                            alt="Close Tickets">
                                        <h3>20</h3>
                                        <p>Close Tickets</p>
                                    </div>
