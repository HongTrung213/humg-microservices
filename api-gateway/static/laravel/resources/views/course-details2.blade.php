                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                <a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail" data-fancybox="">
                                    ...
                                    <img class="img-fluid" src="{{ URL::asset('/assets/img/video-bg.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                                    ...
                                    <div class="col-lg-8 br-1 bb-1">
                                        <div class="complete-sec">
                                            <div class="card-body">
                                                ...
                                                <p>Learn Web Development by building 25 websites and mobile apps using HTML,
                                                    CSS, Javascript, PHP, Python, MySQL & more!</p>
                                                <div class="instructor-wrap border-bottom-0 m-0">
                                                    <div class="about-instructor align-items-center">
                                                        ...
                                                        <div class="instructor-detail">
                                                            <h5><a href="{{ url('instructor-profile') }}">Nicole Brown</a>
                                                            </h5>
                                                            <p>UX/UI Designer</p>
                                                        </div>
                                                ...
                                                <div class="course-info d-flex align-items-center border-bottom-0 p-0 m-0">
                                                    <div class="cou-info">
                                                        <img src="{{ URL::asset('/assets/img/icon/icon-01.svg') }}"
                                                            alt="">
                                                        <p>12+ Lesson</p>
                                                    </div>
                                                    <div class="cou-info">
                                                        <img src="{{ URL::asset('/assets/img/icon/timer-icon.svg') }}"
                                                            alt="">
                                                        <p>9hr 30min</p>
                                                    </div>
                                                    <div class="cou-info">
                                                        <img src="{{ URL::asset('/assets/img/icon/people.svg') }}"
                                                            alt="">
                                    ...
                                    <div class="col-lg-4 bb-1">
                                        <div class="no-video">
                                            <div class="card-body video-details">
                                                ...
                                                <div class="row gx-1">
                                                    <div class="col-sm-6">
                                                        <a href="{{ url('course-wishlist') }}" class="btn btn-wish w-100"><i
                                                    ...
                                                    <div class="col-sm-6">
                                                        <a href="{{ url('cart') }}" class="btn btn-cart w-100">Add To
                                                            Cart</a>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <a href="{{ url('checkout') }}" class="btn btn-enroll w-100">Buy
                                                            Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 br-1">
                                        <div class="card-body include-sec">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <ul>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/import.svg') }}"
                                                                class="me-2" alt=""> 11 hours on-demand video</li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                                class="me-2" alt=""> 69 downloadable resources
                                                        </li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/key.svg') }}"
                                                                class="me-2" alt=""> Full lifetime access</li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-6">
                                                    <ul>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/mobile.svg') }}"
                                                                class="me-2" alt=""> Access on mobile and TV</li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/cloud.svg') }}"
                                                                class="me-2" alt=""> Assignments</li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/teacher.svg') }}"
                                                                class="me-2" alt=""> Certificate of Completion
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="card-body feature-sec">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <ul>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/users.svg') }}"
                                                                class="me-2" alt=""> Enrolled: <span>32
                                                                students</span></li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/timer.svg') }}"
                                                                class="me-2" alt=""> Duration: <span>20
                                                                hours</span></li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/chapter.svg') }}"
                                                                class="me-2" alt=""> Chapters: <span>15</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-6">
                                                    <ul>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/video.svg') }}"
                                                                class="me-2" alt=""> Video:<span> 12
                                                                hours</span></li>
                                                        <li><img src="{{ URL::asset('/assets/img/icon/chart.svg') }}"
                                                                class="me-2" alt=""> Level:
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="course-card">
                                        ...
                                        <div id="collapseOne" class="card-collapse collapse" style="">
                                            <ul>
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture1.1 Introduction to the
                                                        User Experience Course</p>
                                                    <div>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture1.2 Exercise: Your first
                                                        design challenge</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture1.3 How to solve the
                                                        previous exercise</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture1.5 How to use text
                                                        layers effectively</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                    </div>
                                    ...
                                    <div class="course-card">
                                        ...
                                        <div id="coursefour" class="card-collapse collapse" style="">
                                            <ul>
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture4.1 Introduction to the
                                                        User Experience Course</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture4.2 Exercise: Your first
                                                        design challenge</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture4.3 How to solve the
                                                        previous exercise</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture4.4 How to solve the
                                                        previous exercise</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
                                                ...
                                                <li>
                                                    <p><img src="{{ URL::asset('/assets/img/icon/play.svg') }}"
                                                            alt="" class="me-2">Lecture4.5 How to use text
                                                        layers effectively</p>
                                                    <div>
                                                        <a href="javascript:;">Preview</a>
                                                        <span>02:53</span>
