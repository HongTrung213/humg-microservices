                                    ...
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-10.jpg') }}">
                                        </a>
                                        <div class="price">
                            ...
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-11.jpg') }}">
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                            ...
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-12.jpg') }}">
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="course-info border-bottom-0 pb-0 d-flex align-items-center">
                                            ...
                                            <div class="course-view d-flex align-items-center">
                                                <img src="{{ URL::asset('/assets/img/icon/icon-02.svg') }}"
                                                    alt="">
                                                <p>9hr 30min</p>
                                            </div>
                                        </div>
                            ...
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-13.jpg') }}">
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        <div class="head-course-title">
                                            <h3 class="title"><a href="{{ url('course-details') }}">Build Responsive
                            ...
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-16.jpg') }}">
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 d-flex">
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    ...
                                    <div class="product-content">
                                        <div class="head-course-title">
                                            <h3 class="title"><a href="{{ url('course-details') }}">Responsive Web
                            ...
                            <div class="course-box course-design list-course d-flex">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="{{ url('course-details') }}">
                                            <img class="img-fluid" alt=""
                                                src="{{ URL::asset('/assets/img/course/course-17.jpg') }}">
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        <div class="head-course-title">
                                            <h3 class="title"><a href="{{ url('course-details') }}">The Complete App
                            ...
                            <div class="card-body">
                                ...
                                <ul class="latest-posts">
                                    ...
                                    <li>
                                        ...
                                        <div class="post-info free-color">
                                            <h4>
                                                <a href="{{ url('blog-details') }}">Learning jQuery Mobile for
                                                    Beginners</a>
                                            </h4>
                                            <p>FREE</p>
                                        </div>
