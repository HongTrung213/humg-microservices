        ...
        <nav class="navbar navbar-expand-lg header-nav scroll-sticky">
            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    <li
                        ...
                        <ul class="submenu">
                            <li class="{{ Request::is('index','/') ? 'active' : '' }}"><a href="{{ url('index') }}">Home</a>
                            </li>
                    ...
                    <li
                        ...
                        <ul class="submenu">
                            <li
                                class="{{ Request::is('instructor-dashboard', 'dashboard-instructor', 'deposit-instructor-dashboard') ? 'active' : '' }}">
                                <a href="{{ url('instructor-dashboard') }}">Dashboard</a>
                            </li>
                            <li
                                class="has-submenu {{ Request::is('instructor-list', 'instructor-grid', 'instructor-grid-2') ? 'active' : '' }}">
                                <a href="{{ url('instructor-list') }}">Instructor</a>
                                <ul class="submenu">
                                    <li class="{{ Request::is('instructor-list') ? 'active' : '' }}"><a
                                            href="{{ url('instructor-list') }}">List</a></li>
                                    <li
                                        class="{{ Request::is('instructor-grid', 'instructor-grid-2') ? 'active' : '' }}">
                                        <a href="{{ url('instructor-grid') }}">Grid</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('instructor-course') ? 'active' : '' }}"><a
                            ...
                            <li class="{{ Request::is('instructor-earnings') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-earnings') }}">Earnings</a></li>
                            <li class="{{ Request::is('instructor-orders') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-orders') }}">Orders</a></li>
                            <li class="{{ Request::is('instructor-payouts') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-payouts') }}">Payouts</a></li>
                            <li
                                class="{{ Request::is('instructor-tickets', 'instructor-new-tickets') ? 'active' : '' }}">
                                <a href="{{ url('instructor-tickets') }}">Support Ticket</a>
                            </li>
                            <li
                                class="{{ Request::is('instructor-edit-profile', 'instructor-profile') ? 'active' : '' }}">
                                <a href="{{ url('instructor-edit-profile') }}">Instructor Profile</a>
                            </li>
                            <li class="{{ Request::is('instructor-security') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-security') }}">Security</a></li>
                            <li class="{{ Request::is('instructor-social-profiles') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-social-profiles') }}">Social Profiles</a></li>
                            <li class="{{ Request::is('instructor-notification') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-notification') }}">Notifications</a></li>
                            <li class="{{ Request::is('instructor-profile-privacy') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-profile-privacy') }}">Profile Privacy</a></li>
                            <li class="{{ Request::is('instructor-delete-profile') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-delete-profile') }}">Delete Profile</a></li>
                            <li class="{{ Request::is('instructor-linked-account') ? 'active' : '' }}"><a
                                    href="{{ url('instructor-linked-account') }}">Linked Accounts</a></li>
                        </ul>
                    </li>
                    <li
                        class="has-submenu {{ Request::is(
                        ...
                        <ul class="submenu first-submenu">
                            <li
                                class="has-submenu {{ Request::is('students-list', 'students-grid', 'students-grid2') ? 'active' : '' }}">
                                <a href="{{ url('students-list') }}">Student</a>
                                <ul class="submenu">
                                    <li class="{{ Request::is('students-list') ? 'active' : '' }}"><a
                                            href="{{ url('students-list') }}">List</a></li>
                                    <li class="{{ Request::is('students-grid', 'students-grid2') ? 'active' : '' }}"><a
                                            href="{{ url('students-grid') }}">Grid</a></li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('setting-edit-profile', 'student-profile') ? 'active' : '' }}"><a
                                    href="{{ url('setting-edit-profile') }}">Student Profile</a></li>
                            <li class="{{ Request::is('setting-student-security') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-security') }}">Security</a></li>
                            <li class="{{ Request::is('setting-student-social-profile') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-social-profile') }}">Social profile</a></li>
                            <li class="{{ Request::is('setting-student-notification') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-notification') }}">Notification</a></li>
                            <li class="{{ Request::is('setting-student-privacy') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-privacy') }}">Profile Privacy</a></li>
                            <li class="{{ Request::is('setting-student-accounts') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-accounts') }}">Link Accounts</a></li>
                            <li class="{{ Request::is('setting-student-referral') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-referral') }}">Referal</a></li>
                            <li class="{{ Request::is('setting-student-subscription') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-subscription') }}">Subscribtion</a></li>
                            <li class="{{ Request::is('setting-student-billing') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-billing') }}">Billing</a></li>
                            <li class="{{ Request::is('setting-student-payment') ? 'active' : '' }}"><a
                                    href="{{ url('setting-student-payment') }}">Payment</a></li>
                            <li class="{{ Request::is('setting-student-invoice', 'view-invoice') ? 'active' : '' }}">
                                <a href="{{ url('setting-student-invoice') }}">Invoice</a>
                            </li>
                            <li
                                class="{{ Request::is('setting-support-tickets', 'setting-support-new-tickets', 'setting-support-view-tickets') ? 'active' : '' }}">
                                <a href="{{ url('setting-support-tickets') }}">Support Tickets</a>
                            </li>
                        </ul>
                    </li>
                    <li
                        ...
                        <ul class="submenu">
                            ...
                            <li class="{{ Request::is('pricing-plan', 'pricing-plan-2') ? 'active' : '' }}"><a
                                    href="{{ url('pricing-plan') }}">Pricing Plan</a></li>
                            <li class="{{ Request::is('wishlist') ? 'active' : '' }}"><a
                                    href="{{ url('wishlist') }}">Wishlist</a></li>
                            <li
                                class="has-submenu {{ Request::is('add-course', 'course-list', 'course-grid', 'course-details', 'course-details1', 'course-details2') ? 'active' : '' }}">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li
                                        class="{{ Request::is('course-details', 'course-details1', 'course-details2') ? 'active' : '' }}">
                                        <a href="{{ url('course-details') }}">Course Details</a>
                                    </li>
                                </ul>
                            </li>
                            <li
                                class="has-submenu {{ Request::is('come-soon', 'error-404', 'error-500', 'under-construction') ? 'active' : '' }}">
                                <a href="{{ url('come-soon') }}">Error</a>
                                <ul class="submenu">
                                    <li class="{{ Request::is('come-soon') ? 'active' : '' }}"><a
                                            href="{{ url('come-soon') }}">Coming soon</a></li>
                                    ...
                                    <li class="{{ Request::is('under-construction') ? 'active' : '' }}"><a
                                            href="{{ url('under-construction') }}">Under Construction</a></li>
                                </ul>
            ...
            @if (
                ...
                <ul class="nav header-navbar-rht">
                    <li class="nav-item">
                        <a href="{{ url('course-message') }}"><img
                                src="{{ URL::asset('/assets/img/icon/messages.svg') }}" alt="img"></a>
                    </li>
                                            ...
                                            <div class="d-flex media-wide">
                                                <div class="avatar">
                                                    <a href="{{ url('course-details') }}">
                                                        <img alt=""
                                                            src="{{ URL::asset('/assets/img/course/course-04.jpg') }}">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <h6><a href="{{ url('course-details') }}">Learn Angular...</a>
                                                    </h6>
                                                    <p>By Dave Franco</p>
                                        ...
                                        <div class="media">
                                            <div class="d-flex media-wide">
                                                <div class="avatar">
                                                    <a href="{{ url('course-details') }}">
                                                        <img alt=""
                                                            src="{{ URL::asset('/assets/img/course/course-14.jpg') }}">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="d-flex media-wide">
                                                <div class="avatar">
                                                    <a href="{{ url('course-details') }}">
                                                        <img alt=""
                                                            src="{{ URL::asset('/assets/img/course/course-15.jpg') }}">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <h6><a href="{{ url('course-details') }}">C# Developers Double
                                                            ...</a></h6>
                                                    <p>Jesse Stevens</p>
                                                    <h5>$200 <span>$99.00</span></h5>
                                                </div>
                                            ...
                                            <div>
                                                <a href="{{ url('notifications') }}" class="avatar">
                                                    <img class="avatar-img" alt=""
                                                        src="{{ URL::asset('/assets/img/user/user1.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <div class="media d-flex">
                                            <div>
                                                <a href="{{ url('notifications') }}" class="avatar">
                                                    <img class="avatar-img" alt=""
                                                        src="{{ URL::asset('/assets/img/user/user2.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <div class="media d-flex">
                                            <div>
                                                <a href="{{ url('notifications') }}" class="avatar">
                                                    <img class="avatar-img" alt=""
                                                        src="{{ URL::asset('/assets/img/user/user3.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h6><a href="{{ url('notifications') }}">Dennis Nedry <span>commented
                                                            on</span> Isla Nublar SOC2 compliance report</a></h6>
                        ...
                        <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                            <div class="user-header">
                                <div class="avatar avatar-sm">
                                    <img src="{{ URL::asset('/assets/img/user/user11.jpg') }}" alt="User Image"
                            ...
                            <a class="dropdown-item" href="{{ url('setting-edit-profile') }}"><i
            ...
            @if (Route::is([
                ...
                <ul class="nav header-navbar-rht">
                    <li class="nav-item">
                        <a href="{{ url('instructor-chat') }}"><img
                                src="{{ URL::asset('/assets/img/icon/messages.svg') }}" alt="img"></a>
                    </li>
                    <li class="nav-item cart-nav">
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <li class="nav-item user-nav">
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="user-img">
                                <img src="{{ URL::asset('/assets/img/instructor/profile-avatar.jpg') }}"
                                    alt="">
                                <span class="status online"></span>
                            </span>
                        </a>
                        <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                            ...
                            <a class="dropdown-item" href="{{ url('instructor-edit-profile') }}"><i
                        ...
                        <ul class="main-nav">
                            <li class="has-submenu menu-effect active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="active"><a href="{{ url('index-two') }}">Home Two</a></li>
                            ...
                            <li class="has-submenu menu-effect">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu">
                                        <a href="{{ url('instructor-list') }}">Instructor</a>
                                        <ul class="submenu">
                                            <li><a href="{{ url('instructor-list') }}">List</a></li>
                                            <li><a href="{{ url('instructor-grid') }}">Grid</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ url('instructor-course') }}">My Course</a></li>
                                    <li><a href="{{ url('instructor-reviews') }}">Reviews</a></li>
                                    <li><a href="{{ url('instructor-earnings') }}">Earnings</a></li>
                                    <li><a href="{{ url('instructor-orders') }}">Orders</a></li>
                                    <li><a href="{{ url('instructor-payouts') }}">Payouts</a></li>
                                    <li><a href="{{ url('instructor-tickets') }}">Support Ticket</a></li>
                                    <li><a href="{{ url('instructor-edit-profile') }}">Instructor Profile</a></li>
                                    <li><a href="{{ url('instructor-security') }}">Security</a></li>
                                    <li><a href="{{ url('instructor-social-profiles') }}">Social Profiles</a></li>
                                    <li><a href="{{ url('instructor-notification') }}">Notifications</a></li>
                                    <li><a href="{{ url('instructor-profile-privacy') }}">Profile Privacy</a></li>
                                    <li><a href="{{ url('instructor-delete-profile') }}">Delete Profile</a></li>
                                    <li><a href="{{ url('instructor-linked-account') }}">Linked Accounts</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu menu-effect">
                                <a href="">Student <i class="fas fa-chevron-down"></i></a>
                                <ul class="submenu first-submenu">
                                    <li class="has-submenu ">
                                        <a href="{{ url('students-list') }}">Student</a>
                                        <ul class="submenu">
                                            <li><a href="{{ url('students-list') }}">List</a></li>
                                            <li><a href="{{ url('students-grid') }}">Grid</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ url('setting-edit-profile') }}">Student Profile</a></li>
                                    <li><a href="{{ url('setting-student-security') }}">Security</a></li>
                                    <li><a href="{{ url('setting-student-social-profile') }}">Social profile</a></li>
                                    <li><a href="{{ url('setting-student-notification') }}">Notification</a></li>
                                    <li><a href="{{ url('setting-student-privacy') }}">Profile Privacy</a></li>
                                    <li><a href="{{ url('setting-student-accounts') }}">Link Accounts</a></li>
                                    <li><a href="{{ url('setting-student-referral') }}">Referal</a></li>
                                    <li><a href="{{ url('setting-student-subscription') }}">Subscribtion</a></li>
                                    <li><a href="{{ url('setting-student-billing') }}">Billing</a></li>
                                    <li><a href="{{ url('setting-student-payment') }}">Payment</a></li>
                                    <li><a href="{{ url('setting-student-invoice') }}">Invoice</a></li>
                                    <li><a href="{{ url('setting-support-tickets') }}">Support Tickets</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu menu-effect">
                                <a href="">Pages <i class="fas fa-chevron-down"></i></a>
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu">
                                        <a href="{{ url('come-soon') }}">Error</a>
                                        <ul class="submenu">
                                            <li><a href="{{ url('come-soon') }}">Comeing soon</a></li>
                                            <li><a href="{{ url('error-404') }}">404</a></li>
                                            <li><a href="{{ url('error-500') }}">500</a></li>
                                            <li><a href="{{ url('under-construction') }}">Under Construction</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ url('faq') }}">FAQ</a></li>
                                    <li><a href="{{ url('support') }}">Support</a></li>
                                    <li><a href="{{ url('job-category') }}">Category</a></li>
                            ...
                            <li class="has-submenu menu-effect">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ url('blog-masonry') }}">Blog Masonry</a></li>
                                    <li><a href="{{ url('blog-modern') }}">Blog Modern</a></li>
                        ...
                        <ul class="main-nav">
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="active"><a href="{{ url('index-three') }}">Home Three</a></li>
                                    <li><a href="{{ url('index-four') }}">Home Four</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu">
                        ...
                        <ul class="main-nav">
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ url('index-two') }}">Home Two</a></li>
                                    <li><a href="{{ url('index-three') }}">Home Three</a></li>
                                    <li class="active"><a href="{{ url('index-four') }}">Home Four</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu">
                                <a href="">Instructor <i class="fas fa-chevron-down"></i></a>
