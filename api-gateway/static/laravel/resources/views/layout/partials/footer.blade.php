                        ...
                        <div class="footer-widget footer-contact">
                            ...
                            <div class="footer-contact-info">
                                <div class="footer-address">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-20.svg') }}" alt=""
                                        class="img-fluid">
                                    <p> 3556 Beech Street, San Francisco,<br> California, CA 94108 </p>
                                </div>
                                <p>
                                    <img src="{{ URL::asset('/assets/img/icon/icon-19.svg') }}" alt=""
                                        class="img-fluid">
                                    dreamslms@example.com
                                </p>
                                <p class="mb-0">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-21.svg') }}" alt=""
                                        class="img-fluid">
                                    +19 123-456-7890
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <div class="footer-widget-three footer-about">
                                <div class="footer-three-logo">
                                    <img class="img-fluid" src="{{ URL::asset('/assets/img/logo/logo.png') }}"
                                        alt="logo">
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <div class="footer-logo-five">
                                <a href="{{ url('index') }}">
                                    <img src="{{ URL::asset('/assets/img/logo/logo-five.svg') }}" class="img-fluid"
                                        alt="Footer Logo">
                                </a>
