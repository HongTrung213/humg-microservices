                    ...
                    <div class="card instructor-card">
                        ...
                        <div class="card-body">
                            <div class="instructor-grid">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-10.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                            ...
                            <div class="instructor-grid">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-11.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                                <div class="instructor-product-content">
                            ...
                            <div class="instructor-grid">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-12.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                                <div class="instructor-product-content">
                                    <div class="head-course-title">
                                        <h3 class="title"><a href="{{ url('course-details') }}">Sketch from A to Z (2023):
                            ...
                            <div class="instructor-grid">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-13.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                                <div class="instructor-product-content">
                            ...
                            <div class="instructor-grid">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-14.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                                <div class="instructor-product-content">
                            ...
                            <div class="instructor-grid mb-0">
                                <div class="product-img">
                                    <a href="{{ url('course-details') }}">
                                        <img src="{{ URL::asset('/assets/img/course/course-15.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                                <div class="instructor-product-content">
